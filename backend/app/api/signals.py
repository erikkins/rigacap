    ...
    try:
        ...
        if not market_context:
            ...
            system_prompt = (
                ...
                "- SPY STREAK (mandatory): if the 'SPY:' line shows a streak of 3+ straight sessions "
                "(up or down), you MUST work in a reference to it — at least a clause. A sustained "
                "directional move in the index is always material, even when you're leading with a "
                "cross-asset or geopolitical story. A 1-2 session wiggle is not a streak; don't force it.\n"
                ...
                "- Avoid folksy idioms and Brit-isms. NO 'what it says on the tin', 'doing the heavy lifting', "
                "'no joy', 'punching above its weight', 'spot of bother'. The voice is editorial-sharp US-English "
                "(FT/Stratechery register), not pub commentary.\n"
                "- Avoid trader-desk shorthand like 'catches a bid', 'gets bid up', 'finds offers', "
                "'tape action'. Say 'rallies', 'is being bought', 'leads', or 'gains' instead.\n"
