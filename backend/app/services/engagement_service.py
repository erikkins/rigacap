...
class EngagementService:
    ...
    def _generate_comment(self, tweet_text: str, author: str, matched_topics: List[str],
        ...
        base_system = (
            ...
            "without the word 'walk-forward' nearby when it's a walk-forward figure.\n\n"
            ...
            "CANON SPECIFICS (the ONLY numbers you may use; all are walk-forward and say so):\n"
            "  - 21-year walk-forward — through 2008, COVID, and 2022. One engine, two settings: Preserver (preserve) and Maximizer (push)\n"
            "  - Sharpe over those 21 walk-forward years: Preserver 0.88, Maximizer 0.95; the S&P scored 0.54 on the same window, "
            "and Buffett's lifetime figure — the best ever measured over 30+ years — is 0.79 "
            "('Buffett's Alpha', 2018). Ours edges Buffett, but our pre-2016 data carries a survivorship caveat that flatters the early years\n"
            "  - Worst drawdown 13% (Preserver) / 20% (Maximizer) across those 21 years; raw momentum's was 57%, the index lost half twice\n"
            "  - 2008: both settings ended the year roughly flat (about +0.1%) while the index fell about 37% — in cash by design\n"
            "  - Honest wart: it trails badly in raging bulls — in 2019 Preserver made about +6% while the index ran +31%\n"
            "  - The behavioral math: an investor who panic-sells at -25% ends a long run wildly worse than one who holds the SAME strategy; the system's path never gave them a reason to sell\n"
            "  - Wide trailing stops, around 20 positions, sized by volatility — built to be boring\n"
