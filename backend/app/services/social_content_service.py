...
class SocialContentService:
    ...
    _WIN_CLOSERS_TWITTER = [
        "Flagged in real time \u2014 parameters locked in advance.",
        "The exit rule fired and we followed it. That's the whole story.",
        "Real signal, real result \u2014 and we post the losers too.",
        "No hindsight. No curve fitting. Parameters locked before the trade.",
        "The system did this. We just didn't interfere.",
        "The receipts are public \u2014 wins and losses alike.",
        "Flagged before the move, not narrated after it.",
        "Process over outcome. This time the outcome cooperated.",
        "Discipline did the work. We watched.",
        "One trade. The record is what matters, and it's public.",
    ]

    _WIN_CLOSERS_INSTA = [
        "Flagged in real time, parameters locked in advance \u2014 a signal our system surfaced live, not a story reconstructed afterward.",
        "This wasn't a hypothesis. The system flagged it, the rules ran their course, and here's the result.",
        "Every trade we post was a real-time signal. No cherry-picking \u2014 we post the losers too.",
        "The system doesn't get to peek at future data. It has to figure it out live \u2014 just like you.",
        "We show winners and losers. This one happened to be a winner.",
        "The rules were written before the trade existed. That's the entire edge.",
        "The system doesn't know it won. It just moves on to the next signal.",
        "This is what honest systematic trading looks like \u2014 the exit rule fired, we followed it, no 'just a bit longer.'",
        "No discretion anywhere in this trade. That's not a limitation \u2014 it's the product.",
        "Real-time signal, public record. We don't get to edit the past.",
    ]
    ...
    _MISS_OPENERS = [
        ...
        "The signal came before the headlines did.",
        "Zero buzz. All signal.",
        "This move started quietly and ended loudly.",
        "Not trending. Just compounding.",
        "The crowd was looking somewhere else.",
        "Not sexy. Very systematic.",
        "This one was hiding in plain sight.",
        "Not on CNBC. Still on the record.",
        "A trade nobody argued about, because nobody noticed it.",
    ]

    _MISS_CLOSERS_TWITTER = [
        "Flagged in real time \u2014 the record is public.",
        "Our system flagged it live; parameters locked in advance.",
        "Real signal. Real-time. On the record.",
        "Not hindsight \u2014 the flag predates the move, timestamped.",
        "The system doesn't do FOMO. It does process.",
        "No look-ahead, no narrative. Just the rule set doing its job.",
        "Systematic means it was found without anyone believing in it.",
        "The quiet ones add up. That's the design.",
    ]

    _MISS_CLOSERS_INSTA = [
        "Flagged in real time, before the move \u2014 not reconstructed after it. The timestamp is the point.",
        "We post these to show what systematic discovery looks like \u2014 not to make anyone feel bad about a trade they never saw.",
        "No one told us this trade would work. The data flagged it, the rules sized it, the record holds it.",
        "Every trade we post was flagged before it happened. Not after. That's the difference.",
        "Moves like this are why the system scans 4,000 stocks instead of reading headlines.",
        "The market doesn't announce these. A process finds them.",
    ]
    ...
    _RECAP_OPENERS_TWITTER = [
        ...
        "Week's over. Here's the full record:",
        "The algo's weekly report:",
        "Time to check the scoreboard.",
    ]

    _RECAP_CLOSERS_TWITTER = [
        "Every trade flagged in real time. No cherry-picking.",
        "Every trade verified. No look-ahead bias.",
        "Same locked rules, every single trade.",
        "All signals verified in real time.",
        "Real-time flags, public record \u2014 wins and losses alike.",
        "Systematic. Verified. Repeatable.",
        "The system doesn't pick favorites \u2014 some weeks it picks losers, and we post those too.",
    ...
    _RECAP_OPENERS_INSTA = [
        ...
        "This week's record, wins and losses both:",
