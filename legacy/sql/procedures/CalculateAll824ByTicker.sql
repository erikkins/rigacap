-- SqlProcedure: [dbo].[CalculateAll824ByTicker]

set nocount on;

declare @stockID int
select @stockID = stockID from stock where ticker = @ticker;
...
create table #tBuy
	...
	from #rawdata a
	inner join #rawdata b on dateadd(d, case DATEPART(dw,a.atwhen) WHEN 6 then 3 ELSE 1 END, a.atwhen) = b.atwhen
