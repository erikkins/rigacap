...
export default function BlogMarketRegimeGuidePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-300">
      ...
      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-br from-amber-900/70 via-gray-900 to-orange-900/50">
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 py-16 sm:py-24 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full text-sm font-medium mb-6">
            ...
            <span className="text-white/90">Beginner's Guide</span>
          </div>
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="prose prose-invert prose-gray max-w-none">
          ...
          <p className="text-gray-300 leading-relaxed text-base">
            The key insight: <span className="text-white font-medium">you don't need to predict the future — you
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-2 my-8">
          {regimeSpectrum.map((regime) => (
            <div
              key={regime.name}
              className={`${regime.color} rounded-xl p-3 text-center flex flex-col justify-between min-h-[100px]`}
            >
        ...
        <p className="text-sm text-gray-500 text-center mb-8">
          ...
          <Link to="/blog/market-regimes" className="text-blue-400 hover:text-blue-300 underline underline-offset-2 transition-colors">
        ...
        <div className="prose prose-invert prose-gray max-w-none">
          ...
          <p className="text-gray-300 leading-relaxed text-base">
            ...
            should be <span className="text-white font-medium">"should I be buying anything at
        ...
        <div className="grid gap-4 my-8">
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
            <h4 className="text-white font-semibold m-0 mb-2">1. SPY vs. Its 200-Day Moving Average</h4>
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
            <h4 className="text-white font-semibold m-0 mb-2">2. Market Breadth</h4>
            <p className="text-gray-400 text-sm m-0">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
            <h4 className="text-white font-semibold m-0 mb-2">3. The VIX (Market Fear Index)</h4>
            <p className="text-gray-400 text-sm m-0">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
            <h4 className="text-white font-semibold m-0 mb-2">4. Sector Rotation Patterns</h4>
            <p className="text-gray-400 text-sm m-0">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-800">
                  <th className="text-left text-gray-500 uppercase tracking-wider text-xs font-medium px-5 py-3">Regime</th>
                  <th className="text-left text-gray-500 uppercase tracking-wider text-xs font-medium px-5 py-3">Action</th>
                  <th className="text-left text-gray-500 uppercase tracking-wider text-xs font-medium px-5 py-3 hidden sm:table-cell">Why</th>
                </tr>
              </thead>
              <tbody>
                {actionTable.map((row, i) => (
                  <tr key={row.regime} className={i < actionTable.length - 1 ? 'border-b border-gray-800/50' : ''}>
        ...
        {/* CTA */}
        <div className="bg-gradient-to-br from-amber-900/40 to-orange-900/40 border border-amber-500/30 rounded-2xl p-8 sm:p-10 my-12 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">
            See the Current Market Regime
          </h2>
          <p className="text-amber-200/80 mb-6 max-w-lg mx-auto">
