    ...
    <div className="min-h-screen bg-paper font-body text-ink">
      ...
      <section className="bg-paper border-b border-rule">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16 sm:py-24 text-center">
          <p className="text-sm font-medium uppercase tracking-widest text-claret mb-6">Evergreen Investor Playbook</p>
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <div className="prose prose-gray max-w-none">
          ...
          <h2 className="font-display text-2xl font-bold text-ink mt-0 mb-4 flex items-center gap-2" style={{ fontVariationSettings: '"opsz" 48' }}>
            <Brain className="w-6 h-6 text-negative flex-shrink-0" />
        ...
        <div className="grid gap-4 my-8">
          <div className="bg-paper-card border border-negative/20 rounded p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-ink font-semibold mb-1">Don't Panic Sell at the Bottom</h3>
          ...
          <div className="bg-paper-card border border-negative/20 rounded p-6">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 rounded bg-negative/10 flex items-center justify-center flex-shrink-0">
                <span className="text-negative font-bold">2</span>
              </div>
              <div>
                <h3 className="text-ink font-semibold mb-1">Don't "Buy the Dip" Blindly</h3>
                <p className="text-ink-mute text-sm m-0">
          ...
          <div className="bg-paper-card border border-negative/20 rounded p-6">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 rounded bg-negative/10 flex items-center justify-center flex-shrink-0">
                <span className="text-negative font-bold">3</span>
              </div>
              <div>
                <h3 className="text-ink font-semibold mb-1">Don't Check Your Portfolio Every Hour</h3>
                <p className="text-ink-mute text-sm m-0">
          ...
          <div className="bg-paper-card border border-negative/20 rounded p-6">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 rounded bg-negative/10 flex items-center justify-center flex-shrink-0">
                <span className="text-negative font-bold">4</span>
              </div>
              <div>
                <h3 className="text-ink font-semibold mb-1">Don't Listen to Bottom-Callers</h3>
                <p className="text-ink-mute text-sm m-0">
        ...
        <div className="grid gap-4 my-8">
          <div className="bg-paper-card border border-positive/20 rounded p-6">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 rounded bg-positive/10 flex items-center justify-center flex-shrink-0">
                <span className="text-positive font-bold">1</span>
              </div>
              <div>
                <h3 className="text-ink font-semibold mb-1">Have Rules BEFORE the Crash Happens</h3>
                <p className="text-ink-mute text-sm m-0">
          ...
          <div className="bg-paper-card border border-positive/20 rounded p-6">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 rounded bg-positive/10 flex items-center justify-center flex-shrink-0">
                <span className="text-positive font-bold">2</span>
              </div>
              <div>
                <h3 className="text-ink font-semibold mb-1">Use Trailing Stops That Execute Automatically</h3>
                <p className="text-ink-mute text-sm m-0">
          ...
          <div className="bg-paper-card border border-positive/20 rounded p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-ink font-semibold mb-1">Let Market Conditions Tell You When It's Safe</h3>
                <p className="text-ink-mute text-sm m-0">
          ...
          <div className="bg-paper-card border border-positive/20 rounded p-6">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 rounded bg-positive/10 flex items-center justify-center flex-shrink-0">
                <span className="text-positive font-bold">4</span>
              </div>
              <div>
                <h3 className="text-ink font-semibold mb-1">Doing Nothing IS a Strategy</h3>
                <p className="text-ink-mute text-sm m-0">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <h2 className="font-display text-2xl font-bold text-ink mt-12 mb-4 flex items-center gap-2" style={{ fontVariationSettings: '"opsz" 48' }}>
            <TrendingDown className="w-6 h-6 text-negative flex-shrink-0" />
            The Math of Not Losing
          </h2>
          <p className="text-ink-mute leading-relaxed text-base">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-rule">
                <th className="text-left px-6 py-3 text-xs uppercase tracking-wider text-ink-light font-semibold">Portfolio Loss</th>
                <th className="text-right px-6 py-3 text-xs uppercase tracking-wider text-ink-light font-semibold">Gain Needed to Break Even</th>
                <th className="text-right px-6 py-3 text-xs uppercase tracking-wider text-ink-light font-semibold hidden sm:table-cell">$10,000 Becomes</th>
              </tr>
            </thead>
            <tbody>
              {[
                ...
                <tr key={row.loss} className={`border-b border-rule/50 ${row.highlight ? 'bg-negative/10' : ''}`}>
                  <td className={`px-6 py-4 font-semibold ${row.highlight ? 'text-negative' : 'text-negative/80'}`}>{row.loss}</td>
                  <td className={`px-6 py-4 text-right font-semibold ${row.highlight ? 'text-claret' : 'text-claret/80'}`}>{row.gain}</td>
                  <td className="px-6 py-4 text-right text-ink-light hidden sm:table-cell">{row.becomes}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <div className="mt-12 pt-8 border-t border-rule">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Link to="/blog/trailing-stops" className="block p-4 bg-paper-card rounded border border-rule hover:border-rule-dark transition-colors">
              ...
              <span className="block text-ink-light text-sm mt-1">How trailing stops automatically protect gains when markets turn volatile.</span>
            </Link>
            <Link to="/blog/market-regime-guide" className="block p-4 bg-paper-card rounded border border-rule hover:border-rule-dark transition-colors">
              ...
              <span className="block text-ink-light text-sm mt-1">Understanding market regimes helps you prepare before a crash hits.</span>
            </Link>
          </div>
        </div>
