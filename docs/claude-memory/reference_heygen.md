...
- **Avatar IDs — LANDSCAPE (use aspect_ratio 16:9):**
  ...
  - `9e2730b9a3da4e38bcf5d857fd15e503` (confirmed landscape May 18 2026 — earlier classified as portrait in error)
- **Avatar IDs — PORTRAIT (use aspect_ratio 9:16):**
  ...
  - (Note: only 5 confirmed portrait. Re-verify the remaining IDs by test-firing if uncertain — empirical check beats the memory classification.)
