...
- **[Local vs Lambda runtime drift (Jun 2 2026)](project_lambda_runtime_drift_jun2.md)** — Same code, same pickle hash, ~5pp annualized swing between local Python 3.9 and Lambda 3.13. Lambda baseline on validation: 16.73% ann / 1.00 Sharpe / 16.20 MDD / 1.03 Calmar — passes 3 of 4 targets. Gap to North Star is 3.27pp, not 8.76pp. Lambda is now THE authoritative bench; all prior local results invalidated.
